    ...
    return (
      <>
        ...
        {/* 
            ...
            The huge filter region (x="-100%" y="-100%" width="300%" height="300%") prevents edge clipping
            when scale="0.5" creates extreme horizontal/vertical displacement.
        */}
        <svg className="absolute w-0 h-0 overflow-hidden pointer-events-none" aria-hidden="true">
          <filter id={`liquid-glass-${filterId}`} primitiveUnits="objectBoundingBox" x="-100%" y="-100%" width="300%" height="300%">
            <feImage 
              result="map" 
              width="100%" 
              height="100%" 
